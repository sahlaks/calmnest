...
function ChangePassword({ open, onClose }) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
     ...
     if (isValid) {
        try{
        const response = await axiosInstance.post(`/api/parents/change-password`, userDetails, { withCredentials: true })
      ...
      if (error.response) {
        ...
        toast.error('Error occurred while updating the password', {
          className: 'custom-toast',
      });
     }
    }
